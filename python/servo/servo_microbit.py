# kode fra https://github.com/microbit-playground/microbit-servo-class

from microbit import *

# koden under class er litt komplisert men virker
# IKKE endre mellom ****** om du ikke er helt sikker 
#
# *****
class Servo:
